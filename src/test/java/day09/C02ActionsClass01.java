...
// Verify the texts that appear after the buttons are operated.
    ...
    public void test () {
        ...
        WebElement rightClickE = driver.findElement(rightClick);
        ...
        actions
                .doubleClick(doubleClickE)
                .contextClick(rightClickE)
                .click(clickE)
                .perform();
        ...
        Assert.assertTrue(driver.findElement(dynamicClickMessage).isDisplayed());
