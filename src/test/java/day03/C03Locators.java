...
public class C03Locators {
    ...
    public void locatorClass() throws InterruptedException {
        ...
        // We should avoid using long class names that contains spaces between them
    }
    @Test
    ...
    public void locatorPartialLinkText() throws InterruptedException {
        System.out.println(driver.findElement(By.partialLinkText("User Agreemen")).getText());
