...
// Fluent Wait
   ...
   It is global, waits for all web elements.
     */
        ...
        Assert.assertTrue(driver.findElement(By.partialLinkText("Group Tes")).isDisplayed());
    }
     ...
     */
        ...
        //wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("button"))); // wait until located
    ...
    public void fluentWait() {
        ...
        Wait<WebDriver> wait = new FluentWait<>(driver)
                ...
                .pollingEvery(Duration.ofMillis(200)) // polling every 20 seconds for the presence check
        ...
        // wait for 10 seconds for a web element to be on the page, check its presence every 200 milliseconds
    }
}